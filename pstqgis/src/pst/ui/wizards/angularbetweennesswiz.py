...
class CalcOptionsPage(BasePage):
	...
	WEIGHT_MODES = [
		...
		("By segment length", False, "weight_length"),
	]
	...
	def createWidgets(self):
		...
		"""
		prop_sheet.newSection("Output options")
		prop_sheet.addBoolProp("Output node count (N)",   False, "output_N").setEnabled(False)
		prop_sheet.addBoolProp("Output total depth (TD)", False, "output_TD").setEnabled(False)
		prop_sheet.addBoolProp("Output mean depth (MD)",  False, "output_MD").setEnabled(False)
		"""
...
class OutputPage(BasePage):
	...
	def createWidgets(self):
		...
		prop_sheet.addBoolProp("Output node count (N)",   False, "output_N")
		prop_sheet.addBoolProp("Output total depth (TD)", False, "output_TD")
		prop_sheet.addBoolProp("Output mean depth (MD)",  False, "output_MD")
		vlayout = QVBoxLayout()
