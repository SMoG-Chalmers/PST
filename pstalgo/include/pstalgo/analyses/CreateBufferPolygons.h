...
struct SCreateBufferPolygonsDesc 
{
	SCreateBufferPolygonsDesc() : m_Version(VERSION) {}
	...
	bool CreateRangesPolygons;
	bool CreateRangesRaster;
	bool CreateGradientRaster;

	unsigned int OutCategoryCount;

	unsigned int* OutPolygonCountPerCategory;
	...
	psta_raster_handle_t OutRangesRaster;
	psta_raster_handle_t OutGradientRaster;
